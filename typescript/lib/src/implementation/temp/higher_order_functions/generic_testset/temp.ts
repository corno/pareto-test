...
// export const create_collection_transformer = (type: 'group' | 'dictionary', $: p_di.Dictionary<Directory_to_Test_Collection_Result_Transformer>): Directory_to_Test_Collection_Result_Transformer => (dir_group) => $.__d_map(($, id) => {
//     const group_to_test_group_result = $
//     return ['collection', {
//         'type': type === 'group' ? ['group', null] : ['dictionary', null],
//         'result': dir_group.nodes.__get_possible_entry_deprecated(id).__decide(
