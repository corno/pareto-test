...
//             switch ($[0]) {
//                 case 'source invalid': return pt.ss($, ($) => pt.literal.not_set())
...
//                     switch ($[0]) {
//                         case 'passed': return pt.ss($, ($) => pt.literal.not_set())
//                         case 'failed': return pt.ss($, ($) => pt.decide.state($, ($) => {
//                             switch ($[0]) {
//                                 case 'transform': return pt.ss($, ($) => pt.decide.state($, ($) => {
//                                     switch ($[0]) {
//                                         case 'initialization': return pt.ss($, ($) => pt.literal.not_set())
//                                         case 'unexpected output': return pt.ss($, ($) => pt.literal.set(['file', $.actual]))
//                                         default: return pt.au($[0])
//                                     }
//                                 }))
...
//                                         case 'initialization': return pt.ss($, ($) => pt.literal.not_set())
//                                         case 'unexpected output': return pt.ss($, ($) => pt.literal.set(['file', $.actual]))
//                                         case 'unexpected error': return pt.ss($, ($) => pt.literal.set(['file', $.actual]))
//                                         case 'should have failed but succeeded': return pt.ss($, ($) => pt.literal.not_set())
//                                         case 'should have succeeded but failed': return pt.ss($, ($) => pt.literal.not_set())
//                                         default: return pt.au($[0])
//                                     }
//                                 }))
//                                 default: return pt.au($[0])
