...
//     'refiners': _pt.literal.dictionary(refiners).__d_map_deprecated(($) => _pt.literal.dictionary($)),
//     'transformers': _pt.literal.dictionary(transformers).__d_map_deprecated(($) => _pt.literal.dictionary($)),
